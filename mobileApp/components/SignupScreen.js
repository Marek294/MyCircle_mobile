                ...
                <View style={styles.signupContainer}>
                  ...
                  {this.state.errors.username ? <Text style={styles.error}>{this.state.errors.username}</Text> : null }
                   <Item regular style={this.state.errors.username ? styles.inputError : styles.input}>
                      <Input name='username' placeholder='Nazwa użytkownika' onChangeText={(username) => this.setState({username}) } />
                   </Item>
                   ...
                   <Item regular style={this.state.errors.email ? styles.inputError : styles.input}>
                      <Input name='username' placeholder='Adres email' onChangeText={(email) => this.setState({email}) } />
                    </Item>
                   ...
                   <Item regular style={this.state.errors.password ? styles.inputError : styles.input}>
                      <Input name='password' placeholder='Hasło' secureTextEntry={true} onChangeText={(password) => this.setState({password}) } />
                   </Item>
                   ...
                   <Item regular style={this.state.errors.confirmPassword ? styles.inputError : styles.input}>
                      <Input name='confirmPassword' placeholder='Potwierdź hasło' secureTextEntry={true} onChangeText={(confirmPassword) => this.setState({confirmPassword}) } />
                    </Item>
